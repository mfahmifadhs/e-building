      	...
      	<div class="col-12">
	        ...
	        @if ($errors->any())
			    ...
			    <div class="row">
	              ...
	              <!-- /.card-header -->
	              <div class="card-body">
	              	<form action="{{ url('admin-master/update_cleaning_service/'. $data->id_employee ) }}" method="POST">
	                	...
	                	<div class="row">
			                ...
			                <div class="col-md-12">
			                	<button type="submit" class="form-control btn btn-primary" onclick="return confirm('Yakin ingin mengubah data ?')">
			                		<b>UPDATE</b>
			                	</button>
			                </div>
	                	</div>
