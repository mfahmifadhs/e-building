    ...
    <div class="container-fluid">
      <div class="col-md-4" style="margin: 0 auto;float: none;">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ url('pengawas/change_profile') }}" method="POST">
              ...
              <div class="form-group">
                <a href="{{ url('pengawas/show_profile') }}" class="btn btn-danger col-md-12 btn-sm"><b>BATAL</b></a>
              </div>
            </form>
          </div>
          @endforeach
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('pengawas/change_password/') }}" method="POST">
              @csrf
              <div class="col-md-12">
              ...
              <div class="col-md-6">
                <button class="btn btn-info btn-sm"><b>GANTI PASSWORD</b></button>
              </div>
            </form>
          </div>
        </div>
