    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><b>Data Pegawai Banquet & Multimedia</b></li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header" style="background-color:#11B7AE;color: white;">
            <h3 class="card-title-data"><b>Data Pegawai Banquet & Multimedia</b></h3>
            <!-- <form action="{{ url('admin-master/delete_all_banquetmm') }}" method="POST">
              @csrf
              <button class="btn btn-danger add-data" onclick="return confirm('Yakin ingin menghapus semua data?')">
                <i class="fas fa-trash-alt"></i>
              </button>
            </form> -->
            <a href="#add-import-banquetmm" data-toggle="modal" data-target="#add-import-banquetmm" class="btn btn-success add-import-pegawai">
              <i class="fas fa-file-upload"></i>
            </a>
            <a href="#add-banquetmm" data-toggle="modal" data-target="#add-banquetmm" class="btn btn-primary add-data">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">                        
                    <!-- <form action="{{ url('admin-master/delete_banquet_mm',$row->id_employee) }}" method="POST">
                      @csrf -->
                      <a class="btn btn-warning btn-md" href="{{ url('admin-master/edit_banquet_mm',$row->id_employee) }}">
